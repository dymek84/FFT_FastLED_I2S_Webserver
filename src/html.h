...
<html lang="en">
  ...
  <body>
    <div id="app">
      <div id="rangeBlock">
       <div> 
         <b class="Date"><span id="datetime"></span></b>
        </div>
        <div> 
      ...
      <div id="currentEffectElem" style="    font-size: 28px;text-align: center;display: inline;border: solid 4px black;border-radius: 9px;background-color: #0000438c;text-transform: uppercase;">rainbow fade</div>
      <div id="effectsList">
